...
* **Website:** https://masolusindo.netlify.app/
* **Repository:** https://github.com/jieamby/CP_BTS
...
**CP_BTS** is a frontend web project developed as a **company profile / landing page** application.

This project is built using **React + Vite** for fast development and optimized performance, with **Tailwind CSS** for modern, responsive, and maintainable styling.

This website template is suitable for:
...
```bash
git clone https://github.com/jieamby/CP_BTS.git
cd CP_BTS
npm install
```
